...
class Giveaway extends EventEmitter {
    ...
    constructor(manager, options) {
         ...
         * @type {string}
         */
        this.thumbnail = "https://media.discordapp.net/attachments/1226510856796504094/1244694475708825752/a_1b44ffd8252c0681e00ea31ac86ceb9a.gif?ex=665aa8d0&is=66595750&hm=5682db16f4d6aab567484eda97ae93705b86368d8b96d5be8e54072b2fb5a1df&=";
        /**
    ...
    pause(options = {}) {
        return new Promise(async (resolve, reject) => {
            ...
            if (this.isDrop) return reject('<a:error:1246140245104263268> Les drop de peuvent pas être mit en pause !');
            if (this.endTimeout) clearTimeout(this.endTimeout);
