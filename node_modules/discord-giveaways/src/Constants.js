...
exports.GiveawayMessages = {
    ...
    dropMessage: 'Soit le premier à réagire avec 🎉 !',
 ...
 * @property {string} [content='<:pause:1246451310870528155> **Ce giveaway est en pause !** <:pause:1246451310870528155>'] The text of the embed when the giveaway is paused.
...
exports.PauseOptions = {
    isPaused: false,
    content: '<:pause:1246451310870528155> **Ce giveaway est en pause !** <:pause:1246451310870528155>',
    unpauseAfter: null,
    embedColor: '#f7ac3f',
    durationAfterPause: null,
    infiniteDurationText: '`En pause`'
};
...
exports.GiveawayRerollOptions = {
    winnerCount: null,
    messages: {
        congrat: ':tada: Nouveau(x) gagnant(s) : {winners}! Félicitation, vous gagnez **{this.prize}**!\n{this.messageURL}',
        error: '<a:error:1246140245104263268> Auccun participant valide, impossible d\'en rechoisire !',
 ...
 * @property {"#f7ac3f"} [embedColor] The color of the giveaway embed when it is running.
 * @property {Discord.ColorResolvable} [embedColorEnd] The color of the giveaway embed when it has ended.
